    ...
    <div id="chart" v-loading="loading">
        <div class="city-salary" id="city-salary">
            ...
            <div class="city-salary-font">
                ...
                <div class="svg-select">
                  <el-select v-model="comsize" placeholder="请选择">
                      <el-option
                          v-for="item in $parent.companySizeList"
                          :key="item"
                          :label="item"
                          :value="item">
                      </el-option>
            ...
            <div id="eight-container" style="min-width: 800px; height: 400px;"></div>
        </div>
    </div>
  ...
  methods: {
    getComSizeNeedData(){
        ...
        var option={
            ...
            year: self.year,
            comsize: self.comsize
        }
        API.getComSizeNeedData(option).then(res => {
            if(res.success){
    ...
    firstChart() {
      var self = this;
      // highcharts
      var chartsOne = new Highcharts.Chart("eight-container", {
        chart: {
          type: "line"
        },
        title: {
