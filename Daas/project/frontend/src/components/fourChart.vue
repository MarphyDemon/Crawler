<template>
    <div id="chart" v-loading="loading">
        <div class="city-salary" id="city-salary">
            ...
            <div id="four-container" style="min-width: 800px; height: 400px;"></div>
        </div>
    </div>
  ...
  methods: {
    getComSizeData(){
        ...
        var option={
            ...
            city: self.city,
            ComSize: self.companySize
        }
        API.getComSizeData(option).then(res => {
            if(res.success){
    ...
    firstChart() {
      var self = this;
      // highcharts
      var chartsOne = new Highcharts.Chart("four-container", {
        chart: {
          type: "column"
        },
        title: {
