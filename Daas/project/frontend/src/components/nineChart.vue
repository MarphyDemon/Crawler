<template>
    <div id="chart" v-loading="loading">
        <div class="city-salary" id="city-salary">
            ...
            <div id="nine-container" style="min-width: 800px; height: 400px;"></div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    getStageNeedData(){
        ...
        API.getStageNeedData(option).then(res => {
            if(res.success){
    ...
    firstChart() {
      var self = this;
      // highcharts
      var chartsOne = new Highcharts.Chart("nine-container", {
        chart: {
          type: "line"
        },
        title: {
