<template>
    <div id="chart" v-loading="loading">
        <div class="city-salary" id="city-salary">
            ...
            <div id="seven-container" style="min-width: 800px; height: 400px;"></div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    getCityNeedData(){
        ...
        API.getCityNeedData(option).then(res => {
            if(res.success){
    ...
    firstChart() {
      var self = this;
      // highcharts
      var chartsOne = new Highcharts.Chart("seven-container", {
        chart: {
          type: "line"
        },
        title: {
