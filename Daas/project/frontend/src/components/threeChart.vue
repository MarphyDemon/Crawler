<template>
    <div id="chart" v-loading="loading">
        <div class="city-salary" id="city-salary">
            ...
            <div id="three-container" style="min-width: 800px; height: 400px;"></div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    getIndustryData(){
        ...
        API.getIndustryData(option).then(res => {
            if(res.success){
    ...
    firstChart() {
      var self = this;
      // highcharts
      var chartsOne = new Highcharts.Chart("three-container", {
        chart: {
          type: "column"
        },
        title: {
