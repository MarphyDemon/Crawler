<template>
    <div id="chart" v-loading="loading">
        <div class="city-salary" id="city-salary">
            ...
            <div id="two-container" style="min-width: 800px; height: 400px;"></div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    getCityData(){
        ...
        API.getCityData(option).then(res => {
            if(res.success){
    ...
    firstChart() {
      var self = this;
      // highcharts
      var chartsOne = new Highcharts.Chart("two-container", {
        chart: {
          type: "column"
        },
        title: {
